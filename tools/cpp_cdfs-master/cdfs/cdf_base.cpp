...
//NOTE  Removing this, because it is a pain to need to define all the errors
//     R_CheckUserInterrupt();
//     warning("Not running R_CheckUserInterrupt");
...
//////////////////////////////////////////////////////////////////////////////
// noncentral chi-square, from pnchisq.c
//////////////////////////////////////////////////////////////////////////////
...
// not adding quantile function because (a) it seems like a bit of effort
// (qDiscrete.h, another 300 lines) and (b) not sure how often the quantile 
// function for the Poisson distribution is used.
...
// needed for dhyper, which is needed for phyper
...
double cdf_normal(double x, double mu, double sigma, int lower_tail){
    return pnorm(x, mu, sigma, lower_tail, false);
}

//cdf of normal dist, log
double cdf_normal_log(double x, double mu, double sigma, int lower_tail){
    return pnorm(x, mu, sigma, lower_tail, true);
}

//quantile of normal dist, no log
double quantile_normal(double p, double mu, double sigma, int lower_tail){
    return qnorm(p, mu, sigma, lower_tail, false);
}

//quantile of normal dist, log
double quantile_normal_log(double p, double mu, double sigma, int lower_tail){
...
double cdf_gamma(double x, double shape, double scale, int lower_tail){
    return pgamma(x, shape, scale, lower_tail, false);
}


//cdf of Gamma distribution, log_p=true
double cdf_gamma_log(double x, double shape, double scale, int lower_tail){
    return pgamma(x, shape, scale, lower_tail, true);
}


//quantile function of Gamma distribution, log_p=false
double quantile_gamma(double p, double shape, double scale, int lower_tail){
    return qgamma(p, shape, scale, lower_tail, false);
}


//quantile function of Gamma distribution, log_p=true
double quantile_gamma_log(double p, double shape, double scale, int lower_tail){
    return qgamma(p, shape, scale, lower_tail, true);
}


//noncentral chisq cdf, no log 
double cdf_noncentral_chisq(double x, double df, double ncp, int lower_tail){
    return pnchisq(x, df, ncp, lower_tail, false);
}


//noncentral chisq cdf, log
double cdf_noncentral_chisq_log(double x, double df, double ncp, int lower_tail){
    return pnchisq(x, df, ncp, lower_tail, true);
}


//noncentral chi-squared distribution quantile function
double quantile_noncentral_chisq(double p, double df, double ncp, int lower_tail){
    return qnchisq(p, df, ncp, lower_tail, false);
}


//beta cdf, no log 
double cdf_beta(double x, double a, double b, int lower_tail){
    return pbeta(x, a, b, lower_tail, false);
}

//beta cdf, with log 
double cdf_beta_log(double x, double a, double b, int lower_tail){
    return pbeta(x, a, b, lower_tail, true);
}


// poisson cdf, no log
double cdf_poisson(double x, double lambda, int lower_tail){
    return ppois(x, lambda, lower_tail, false);
}

// poisson cdf, with log
double cdf_poisson_log(double x, double lambda, int lower_tail){
    return ppois(x, lambda, lower_tail, true);
}


// binomial cdf, no log
double cdf_binomial(double x, double n, double p, int lower_tail){
    return pbinom(x, n, p, lower_tail, false);
}


// binomial cdf, with log
double cdf_binomial_log(double x, double n, double p, int lower_tail){
    return pbinom(x, n, p, lower_tail, true);
}


// F distribution cdf, no log
double cdf_f(double x, double df1, double df2, int lower_tail){
    return pf(x, df1, df2, lower_tail, false);
}

// F distribution cdf, no log
double cdf_f_log(double x, double df1, double df2, int lower_tail){
    return pf(x, df1, df2, lower_tail, true);
}


// Exponential distribution cdf, no log
double cdf_exp(double x, double rate, int lower_tail){
    return pexp(x, 1/rate, lower_tail, false);
}


// Exponential distribution cdf, with log
double cdf_exp_log(double x, double rate, int lower_tail){
    return pexp(x, 1/rate, lower_tail, true);
}


// Geometric distribution cdf, no log
double cdf_geom(double x, double p, int lower_tail){
    return pgeom(x, p, lower_tail, false);
}

// Geometric distribution cdf, with log
double cdf_geom_log(double x, double p, int lower_tail){
    return pgeom(x, p, lower_tail, true);
}


// Cauchy distribution cdf, no log
double cdf_cauchy(double x, double loc, double scale, int lower_tail){
    return pcauchy(x, loc, scale, lower_tail, false);
}

// Cauchy distribution cdf, with log
double cdf_cauchy_log(double x, double loc, double scale, int lower_tail){
    return pcauchy(x, loc, scale, lower_tail, true);
}


// Weibull distribution cdf, no log
double cdf_weibull(double x, double shape, double scale, int lower_tail){
    return pweibull(x, shape, scale, lower_tail, false);
}

// Weibull distribution cdf, with log
double cdf_weibull_log(double x, double shape, double scale, int lower_tail){
    return pweibull(x, shape, scale, lower_tail, true);
}


// hypergeometric distribution cdf, no log
double cdf_hypergeometric(double x, double m, double n, double k, int lower_tail){
    // phyper     (x,NR,NB, n, lower_tail, false)
    return phyper (x, m, n, k, lower_tail, false);
}


// hypergeometric distribution cdf, with log
double cdf_hypergeometric_log(double x, double m, double n, double k, int lower_tail){
    return phyper (x, m, n, k, lower_tail, true);
}


//cdf of lognormal dist, no log
double cdf_lognormal(double x, double meanlog, double sdlog, int lower_tail){
    return plnorm(x, meanlog, sdlog, lower_tail, false);
}

//cdf of lognormal dist, log
double cdf_lognormal_log(double x, double meanlog, double sdlog, int lower_tail){
    return plnorm(x, meanlog, sdlog, lower_tail, true);
}
