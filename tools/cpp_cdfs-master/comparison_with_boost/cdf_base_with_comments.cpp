...
//TODO: Alternative ML_POSINF, etc
//from nmath.h
...
*/
    ...
    //TODO: note that using lgammaf here, defined in math.h
    //TODO: Actually, using call above, now that defined lgammafn call above
	//return(lgammaf(n + 1.) - (n + 0.5)*log(n) + n - M_LN_SQRT_2PI);
    }
