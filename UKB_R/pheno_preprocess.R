...
# Less than an hour a day set to NA.
newpheno[,paste0('X',meta_i[V20=='Data-Coding 100329']$FieldID,'.0.0')][
  pheno[,paste0('X',meta_i[V20=='Data-Coding 100329']$FieldID,'.0.0')]<0] = NA
...
fwrite(new_meta,"/public3/project_users/chengb/hjc/projects/MR/pheno/pheno_set_0421_129.table",quote=F,sep=' ')
newpheno = cbind(newpheno[,c(1,2)],newpheno[,paste0('X',new_meta$FieldID,'.0.0')],pheno[,paste0('PC',1:20)])
fwrite(newpheno,"/public3/project_users/chengb/hjc/projects/MR/pheno/129_filtered_pheno_20pcs_non_scaled_0421.table",quote=F,sep=' ',row.names=F)
scaledpheno = cbind(newpheno[,c(1,2)],scale(newpheno[,paste0('X',new_meta$FieldID,'.0.0')]),scale(pheno[,paste0('PC',1:20)]))
fwrite(scaledpheno,"/public3/project_users/chengb/hjc/projects/MR/pheno/129_filtered_pheno_20pcs_scaled_0421.table",quote=F,sep=' ',row.names=F)
