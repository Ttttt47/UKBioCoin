...
{   
	...
	des_cmd.add_options()
        ("help,h", "help");
		("file", opt::value<std::string>(), "Names of the covariance matrices.")
		("phe", opt::value<std::string>(), "Name of the phenotype that match the column names in the covariace matrix.")
		("covar", opt::value<std::string>(), "Names of the covariates that match the column names in the covariace matrix, seperated by comma and nothing else. e.g. \"X1,X2,X3\".")
		("out", opt::value<std::string>(), "prefix of the output file.")
